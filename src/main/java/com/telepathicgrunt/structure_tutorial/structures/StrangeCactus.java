...
public class StrangeCactus extends Structure {

    public static final Codec<StrangeCactus> CODEC = RecordCodecBuilder.<StrangeCactus>mapCodec(instance ->
            instance.group(StrangeCactus.configCodecBuilder(instance),
            ...
            ).apply(instance, StrangeCactus::new)).codec();
    ...
    public StrangeCactus(Structure.Config config,
